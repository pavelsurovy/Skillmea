...
let arrPrvok1 = [43, 21, 92, 75, 68, 86, 9, 52, 57, 5, 5, 69, 29, 63, 12, 27, 97, 7, 88, 93, 96, 18, 57, 58, 64, 92, 62, 27, 90, 16, 10, 77, 1, 56, 60, 61, 62, 7, 39, 23, 81, 47, 27, 87, 19, 20, 28, 9, 99, 61]
let arrPrvok2 = [89, 1, 30, 81, 19, 31, 50, 10, 61, 24, 72, 22, 7, 37, 46, 59, 34, 40, 51, 90, 60, 0, 54, 7, 86, 12, 13, 86, 74, 87, 94, 19, 26, 43, 22, 72, 45, 5, 7, 42, 74, 53, 89, 87, 97, 52, 45, 17, 36, 66]

let nachadza = arrSlova.contains("duic")
let pozicia = arrSlova.firstIndex(of: "eros")

// nájdi unikátny prvok, ktorý sa nachádza v oboch poliach
